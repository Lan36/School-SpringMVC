...
<fm:form modelAttribute="bookInfo" action="${pageContext.request.contextPath}/Book/addBookInfo" method="post">
    ...
    图书价格:<fm:input path="price"/><br/><br/>
    ...
    <fm:radiobutton path="has" value="无" label="无"/>&nbsp;&nbsp;
    <br/><br/>
    <%--<fm:form modelAttribute="bookInfo" action="bookAdd" method="post"></fm:form>--%>
    出版社:
    <fm:select path="pub">
        <fm:option value="清华大学出版社">清华大学出版社</fm:option>
        <fm:option value="机械工业出版社">机械工业出版社</fm:option>
        <fm:option value="人民邮电出版社">人民邮电出版社</fm:option>
    </fm:select><br/><br/>
    图书类型:
    <fm:select path="type">
        <fm:options items="${bookTypeList}" itemLabel="typeName" itemValue="typeId"></fm:options>
    </fm:select><br/><br/>
